              ...
              <div className="mt-4 md:mt-0 flex space-x-3">
                {isOwner && (
                  <button
                    ...
                    className="px-6 py-3 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 flex items-center"
                  >
                    <span className="mr-2">📊</span>
                    Analytics
                  </button>
        ...
        <div className="mt-8">
          ...
          {activeTab === 'social' && (
            <div className="bg-white rounded-xl shadow p-8">
              ...
              {/* show shop social feed component, fallback message handled internally */}
              <ShopSocialFeed shopId={shopId} limit={50} compact={false} />
            </div>
          )}
