        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-3 px-8 rounded-lg disabled:opacity-50"
            >
              {runningTests ? 'Testler Çalışıyor...' : 'TÜM TESTLERİ ÇALIŞTIR'}
            </button>
